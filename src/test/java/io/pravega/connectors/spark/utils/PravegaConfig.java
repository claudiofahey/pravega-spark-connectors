...
public class PravegaConfig implements Serializable {
    ...
    PravegaConfig(Properties properties, Map<String, String> env) {
        this.controllerURI = CONTROLLER_PARAM.resolve(properties, env).map(URI::create).orElse(null);
        this.defaultScope = SCOPE_PARAM.resolve(properties, env).orElse(null);
    }
    ...
    public static PravegaConfig fromDefaults() {
        return new PravegaConfig(System.getProperties(), System.getenv());
    }
    ...
    static class PravegaParameter implements Serializable {
        ...
        public Optional<String> resolve(Properties properties, Map<String, String> variables) {
